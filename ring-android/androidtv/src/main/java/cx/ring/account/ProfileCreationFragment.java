...
public class ProfileCreationFragment extends RingGuidedStepFragment<ProfileCreationPresenter>
    ...
    public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
        ...
        Drawable icon = getActivity().getDrawable(R.drawable.ic_contact_picture);
    ...
    public void goToNext() {
        ...
        ((AccountWizard) getActivity()).profileNext(editText.getEditDescription().toString(), null);
    }
