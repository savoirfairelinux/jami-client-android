...
public class AccountWizard
    ...
    private ProfileCreationFragment mProfileFragment = new ProfileCreationFragment();
    private HomeAccountCreationFragment mHomeFragment = new HomeAccountCreationFragment();
    ...
    public void newAccount(boolean isNewAccount) {
        ...
        if (mLinkAccount) {
            GuidedStepFragment.add(getFragmentManager(), new ProfileCreationFragment());
        } else {
            GuidedStepFragment.add(getFragmentManager(), new RingAccountCreationFragment());
        }
    }
    ...
    public void profileNext(String fullname, Bitmap photo) {
        mFullname = fullname;
        if (mLinkAccount) {
            GuidedStepFragment.add(getFragmentManager(), new RingLinkAccountFragment());
        } else {
            GuidedStepFragment.add(getFragmentManager(), new RingAccountCreationFragment());
        }
    }
