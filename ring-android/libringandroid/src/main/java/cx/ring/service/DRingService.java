...
public class DRingService extends Service implements Observer<ServiceEvent> {
    ...
    private final BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (intent.getAction()) {
                ...
                case Constants.DRING_CONNECTION_CHANGED: {
    ...
    private void parseIntent(Intent intent) {
        ...
        switch (intent.getAction()) {
            ...
            case Constants.ACTION_CALL_END:
            ...
            switch (arg.getEventType()) {
                case ACCOUNTS_CHANGED:
                    ...
                    sharedPreferences.edit()
                            .putBoolean(Constants.KEY_CACHE_HAVE_RINGACCOUNT, mAccountService.hasRingAccount())
                            .putBoolean(Constants.KEY_CACHE_HAVE_SIPACCOUNT, mAccountService.hasSipAccount()).apply();
