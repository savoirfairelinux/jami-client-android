...
class CallPresenter @Inject constructor(
    ...
    /**
     * showConference() receive update of the Observable<Conference> data before dispatching it to the element who are subscribed to
     * this will lead to new conference data, which will impact your view
     * @param : mCallService.getConfUpdate()
