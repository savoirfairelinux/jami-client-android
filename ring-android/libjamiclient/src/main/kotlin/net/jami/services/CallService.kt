...
/*    fun accept(callId: String) {
    ...
    private fun parseCallState(accountId: String, callId: String, newState: String, callDetails: HashMap<String, String>): Call? {
    ...
    fun callStateChanged(accountId: String, callId: String, newState: String, detailCode: Int) {
        val callDetails = JamiService.getCallDetails(accountId, callId).toNative();
