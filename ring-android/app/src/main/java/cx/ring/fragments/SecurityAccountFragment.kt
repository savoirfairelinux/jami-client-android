...
class SecurityAccountFragment : BasePreferenceFragment<SecurityAccountPresenter>(), SecurityAccountView {
    ...
    override fun onCreatePreferences(bundle: Bundle, s: String) {
        ...
        credentialsCategory = findPreference<Preference>("Account.credentials") as PreferenceCategory?
        credentialsCategory!!.findPreference<Preference>("Add.credentials")!!.onPreferenceChangeListener =
            addCredentialListener
        tlsCategory = findPreference<Preference>("TLS.category") as PreferenceCategory?
