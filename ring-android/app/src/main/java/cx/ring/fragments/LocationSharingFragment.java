...
public class LocationSharingFragment extends DialogFragment {
    ...
    public static LocationSharingFragment newInstance(String accountId, String conversationId) {
        ...
        fragment.setArguments(ConversationPath.toBundle(accountId, conversationId));
        return fragment;
    }
    ...
    public static CharSequence formatDuration(long millis, MeasureFormat.FormatWidth width) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_location_sharing, container, false);
        mMap = view.findViewById(R.id.map);
        mShareButton = view.findViewById(R.id.btn_share_location);
        view.findViewById(R.id.btn_center_position).setOnClickListener(v -> {
            if (overlay != null)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            chip_1h.setText(formatDuration( 60 * 60 * 1000L, MeasureFormat.FormatWidth.WIDE));
            Chip chip_10m = view.findViewById(R.id.location_share_time_10m);
            chip_10m.setText(formatDuration( 10 * 60 * 1000L, MeasureFormat.FormatWidth.WIDE));
        }
        return view;
    }
                    ...
                    .subscribe(locations -> {
                        ...
                        if (ctx != null) {
                            ...
                            for (LocationViewModel vm : locations) {
                                ...
                                m.setPosition(new GeoPoint(vm.location.latitude, vm.location.longitude));
