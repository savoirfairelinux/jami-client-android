    ...
    private void updateContactBubble() {
        ...
        if (conference != null) {
            ...
            if (participants != null && participants.size() > 0) {
                ...
                if (context != null) {
                    String host = participant.getNumberUri().getHost();
                    String vcard = VCardUtils.loadFromDisk(host + ".vcf",context);
                    if(TextUtils.isEmpty(vcard)) {
                        ...
                        Bitmap image = VCardUtils.getImage(vcard);
                        if (image != null) {
                            contactBubbleView.setImageBitmap(image);
                        }
