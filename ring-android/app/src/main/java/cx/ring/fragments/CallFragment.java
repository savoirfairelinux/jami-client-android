...
public class CallFragment extends BaseSupportFragment<CallPresenter> implements CallView, MediaButtonsHelper.MediaButtonsHelperCallback {
    ...
    private void moveIn() {
        ...
        int translationPreview = isRight ? -300 : 300;
        binding.previewContainer.setVisibility(View.VISIBLE);
        binding.previewContainer.animate()
                .setDuration(300)
                .translationXBy(translationPreview);

        int translationShowPreview = PreviewPosition.isRight(lastKnownPreviewPosition) ? 90 : -90;
    ...
    public void moveOut() {
        ...
        if (PreviewPosition.isRight(lastKnownPreviewPosition)) {
            params.removeRule(RelativeLayout.ALIGN_PARENT_LEFT);
            params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            params.setMargins(UIUtils.dpToPx(12), params.topMargin, UIUtils.dpToPx(-65), params.bottomMargin);
        } else {
            params.removeRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            params.addRule(RelativeLayout.ALIGN_PARENT_LEFT);
            params.setMargins(UIUtils.dpToPx(-65), params.topMargin, UIUtils.dpToPx(12), params.bottomMargin);
        }
        ...
        int translationShowPreview = isRight ? -90 : 90;
        binding.showPreview.animate()
                .setDuration(300)
                .translationX(translationShowPreview);
    }
