...
public class CallFragment extends BaseFragment<CallPresenter> implements CallView {
    ...
    public void updateContactBubble(final String contactName) {
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (!contactBubbleTxt.getText().equals(contactName)) {
    ...
    @Override
    public void initMenu(boolean isSpeakerOn, boolean hasContact, boolean displayFlip, boolean canDial) {
    ...
    public void initContactDisplay(final SipCall call) {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (contactBubbleTxt.getText().toString().isEmpty() && name.equals(call.getNumber())) {
