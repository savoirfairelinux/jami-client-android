                        ...
                        animate()
                            ...
                            .setListener(object : AnimatorListenerAdapter() {
                                override fun onAnimationEnd(animation: Animator?) {
                                    ...
                                    val paddingAnimation = ValueAnimator.ofInt(this@apply.paddingBottom, 0);
                                    paddingAnimation.addUpdateListener { valueAnimator ->
                                        Log.w(TAG, "DEBUG paddingAnimation -> animatedValue: ${valueAnimator.animatedValue}")
                                        this@apply.updatePadding(bottom = (valueAnimator.animatedValue as Int))
                                    }
                                    paddingAnimation.duration = 500
