...
import static cx.ring.plugins.PluginUtils.listChatHandlersDetails;
...
public class PluginHandlersListFragment extends Fragment implements PluginsListAdapter.PluginListItemListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new PluginsListAdapter(listChatHandlersDetails(binding.handlerList.getContext(), mPath.getAccountId(), mPath.getConversationId()), this);
    ...
    public void onPluginItemClicked(PluginDetails pluginDetails) {
        toggleChatHandler(pluginDetails.getRootPath(), mPath.getAccountId(), mPath.getConversationId(), pluginDetails.isEnabled());
    }
