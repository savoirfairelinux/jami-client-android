...
/*
        ...
        findPreference("SRTP.details").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
...
*/
    ...
    public void setTLSListener() {
        for (int i = 0; i < tlsCategory.getPreferenceCount(); ++i) {
            tlsCategory.getPreference(i).setOnPreferenceChangeListener(tlsListener);
        }
    }
