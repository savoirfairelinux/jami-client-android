...
public class AccountsManagementFragment extends BaseSupportFragment<AccountsManagementPresenter> implements AccountsManagementView,
    ...
    public void onResume() {
        super.onResume();
        Log.w(TAG, "onResume()");
        FloatingActionButton button = ((HomeActivity) getActivity()).toggleActionButton(true);
    ...
    public void onStop() {
        super.onStop();
        Log.w(TAG, "onStop()");
        FloatingActionButton button = ((HomeActivity) getActivity()).toggleActionButton(false);
