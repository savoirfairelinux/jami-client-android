...
public class MediaPreferencePresenter extends RootPresenter<MediaPreferenceView> {
    ...
    private void getCodecs(Account account) {
        boolean isRingtoneEnabled = Boolean.valueOf(account.getDetail(ConfigKey.RINGTONE_ENABLED));
        boolean isCustomRingtoneEnabled = isRingtoneEnabled && Boolean.valueOf(account.getDetail(ConfigKey.RINGTONE_CUSTOM));
