...
public class LocalService extends Service implements Observer<DaemonEvent> {
    ...
    public void refreshConversations() {
        ...
        cx.ring.utils.Log.d(TAG, "-----------------------> REFRESHING CONVERSATIONS");
    ...
    private final Loader.OnLoadCompleteListener<ContactsLoader.Result> onSystemContactsLoaded = new Loader.OnLoadCompleteListener<ContactsLoader.Result>() {
        ...
        public void onLoadComplete(Loader<ContactsLoader.Result> loader, ContactsLoader.Result data) {
            ...
            cx.ring.utils.Log.d(TAG, "-----------------------> CONTACT LOADER HAS FINISHED");
    ...
    private class ConversationLoader extends AsyncTask<Void, Void, Map<String, Conversation>> {
        ...
        protected Map<String, Conversation> doInBackground(Void... params) {
            ...
            try {
                ...
                cx.ring.utils.Log.d(TAG, "-----------------------> CONVERSATION LOADER IS STARTING");
    ...
    private void updated(Map<String, Conversation> res) {
        ...
        Log.d(TAG, "-----------------------> CONVERSATION ARE LOADED");
    }
        ...
        if (observable instanceof AccountService && arg != null) {
            switch (arg.getEventType()) {
                case ACCOUNTS_CHANGED:
                    ...
                    cx.ring.utils.Log.d(TAG, "-----------------------> LOCALSERVICE IS NOTIFIED THAT ACCOUNTS ARE LOADED");
                    ...
                    cx.ring.utils.Log.d(TAG, "-----------------------> LOCALSERVICE PREFERENCES ARE SET");
                    ...
                    cx.ring.utils.Log.d(TAG, "-----------------------> LOCALSERVICE CONTACTS WILL BE LOADED");
                    mSystemContactLoader.startLoading();
                    cx.ring.utils.Log.d(TAG, "-----------------------> LOCALSERVICE CONTACTS WILL BE FORCE LOADED");
