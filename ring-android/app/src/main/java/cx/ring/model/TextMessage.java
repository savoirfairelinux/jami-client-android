...
public class TextMessage implements Parcelable {
    ...
    public static String NUMBER = "mNumber";
    public static String TYPE = "type";
    public static String STATE = "State";
    public static String MESSAGE = "mMessage";
    ...
    public TextMessage(TextMessage call) {
        mID = call.mID;
        mAccount = call.mAccount;
        mContact = call.mContact;
        mNumber = call.mNumber;
        timestamp_ = call.timestamp_;
        mType = call.mType;
        mState = call.mState;
        mMessage = call.mMessage;
    }
    ...
    public TextMessage(String account, String mNumber, String mMessage, boolean in) {
        mAccount = account;
