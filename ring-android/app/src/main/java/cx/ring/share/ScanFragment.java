...
public class ScanFragment extends BaseSupportFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (DeviceUtils.isTablet(mActivity)) {
            isTabletMode = true;
        }
    ...
    private void initializeBarcode() {
        if (barcodeView != null) {
            ...
            barcodeView.initializeFromIntent(mActivity.getIntent());
    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(@NonNull BarcodeResult result) {
            if (result.getText() == null) {
                ...
                ACCOUNT_ID = mActivity.getIntent().getExtras().getString(QR_ACCOUNT_ID);
    ...
    public void goToConversation(String accountId, cx.ring.model.Uri contactId) {
        if (!isTabletMode) {
            Intent intent = new Intent()
                    .setClass(mActivity, ConversationActivity.class)
            ...
            ((QRCodeActivity) mActivity).startConversationTablet(bundle);
        }
    }
