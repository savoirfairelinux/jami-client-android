...
public class RingtoneActivity extends AppCompatActivity {
    ...
    private void setPreference() {
        ...
        if (customEnabled) {
            ...
            adapter.selectDefaultItem(path.getAbsolutePath(), isRingtoneEnabled());
        }
    }
    ...
    private void displayRemoveDialog() {
        ...
        new AlertDialog.Builder(this)
                .setItems(item, (dialog, which) ->
                        removeCustomRingtone()).show();
    }

    /**
     * Checks if ringtones are enabled
     * @return false if silent
     */
    private boolean isRingtoneEnabled() {
        return mAccount.getConfig().getBool(ConfigKey.RINGTONE_ENABLED);
    }
