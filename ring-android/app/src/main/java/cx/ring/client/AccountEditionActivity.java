    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSlidingTabLayout.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (mCurrentlyDisplayed instanceof RingSummaryAccountFragment) {
                    RingSummaryAccountFragment deviceAccountFragment = (RingSummaryAccountFragment) mCurrentlyDisplayed;
        ...
        if (mAccSelected.isRing()) {
            ...
            mCurrentlyDisplayed = new RingSummaryAccountFragment();
