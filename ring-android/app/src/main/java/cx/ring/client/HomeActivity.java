...
public class HomeActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener,
    ...
    private static final String SHARE_CATEGORY = "cx.ring.client.ShareActivity";
    ...
    private void setShareShortcuts(Account account) {
        ...
        for (cx.ring.model.Conversation conversation : conversations) {
        ...
        for (cx.ring.model.Conversation conversation : conversations) {
            ...
            Bundle bundle = new Bundle();
            bundle.putString(ConversationFragment.KEY_ACCOUNT_ID, account.getAccountID());
            bundle.putString(ConversationFragment.KEY_CONTACT_RING_ID, contact.getPrimaryNumber());

            Uri uri = new Uri.Builder().scheme("jami")
                    .authority("share")
                    .appendQueryParameter(ConversationFragment.KEY_ACCOUNT_ID, account.getAccountID())
                    .appendQueryParameter(ConversationFragment.KEY_CONTACT_RING_ID, contact.getPrimaryNumber())
                    .build();
            ...
            ShortcutInfoCompat shortcutInfo = new ShortcutInfoCompat.Builder(this, contact.getPrimaryNumber())
                    .setShortLabel(contact.getDisplayName())
                    .setPerson(person)
                    .setLongLived(true)
                    .setIcon(icon)
                    .setCategories(Collections.singleton(SHARE_CATEGORY))
                    .setIntent(new Intent(Intent.ACTION_SEND, uri, this, ShareActivity.class).putExtras(bundle))
                    .build();
