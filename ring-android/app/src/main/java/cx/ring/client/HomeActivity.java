...
public class HomeActivity extends AppCompatActivity implements LocalService.Callbacks,
    ...
    private String mAccountWithPandingrequests = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ACTION_PRESENT_TRUST_REQUEST_FRAGMENT.equals(getIntent().getAction())) {
            if (extra == null || extra.getString(PendingTrustRequestsFragment.ACCOUNT_ID) == null) {
                return;
            }
            mAccountWithPandingrequests = extra.getString(PendingTrustRequestsFragment.ACCOUNT_ID);
        }
    }
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder s) {
            ...
            if (mAccountWithPandingrequests != null) {
                presentTrustRequestFragment(mAccountWithPandingrequests);
                mAccountWithPandingrequests = null;
            }
