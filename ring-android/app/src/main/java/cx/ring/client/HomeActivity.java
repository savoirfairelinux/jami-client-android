...
public class HomeActivity extends AppCompatActivity implements LocalService.Callbacks, DialingFragment.Callbacks,
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder s) {
            ...
            /*if (getIntent().getAction().contentEquals(Intent.ACTION_MANAGE_NETWORK_USAGE)) {
                fContent = new SettingsFragment();
                getFragmentManager().beginTransaction().replace(R.id.main_frame, fContent, "Prefs").addToBackStack("Prefs").commitAllowingStateLoss();
            } else {*/
