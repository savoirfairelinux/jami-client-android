...
class AccountAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<String> getAccountOrder() {
        List<String> result = new ArrayList<>(mDataset.size());
