    ...
    public static class PrefsFragment extends JamiPreferenceFragment<GeneralAccountPresenter> implements GeneralAccountView {
        ...
        public void displayRestartDialog() {
            new AlertDialog.Builder(getActivity())
                    .setMessage(R.string.pref_restart_dialog)
                    .setNegativeButton(R.string.pref_restart_dialog_no, null)
                    .setPositiveButton(R.string.pref_restart_dialog_yes, (dialog, which) -> restartApplication())
                    .show();
        }
