...
public class AboutCardHelper {
    ...
    public static AboutCard getVersionCard(Context pContext) {
        return new AboutCard(Card.Type.VERSION, pContext.getString(R.string.version_section) + " 1.0" + " " + BuildConfig.VERSION_NAME, "", "ic_ring_logo_white");
    }

    public static AboutCard getLicencesCard(Context pContext) {
        return new AboutCard(Card.Type.LICENCES, pContext.getString(R.string.section_license), formatLicence(pContext), "ic_description");
    }

    public static AboutCard getContributorCard(Context pContext) {
        return new AboutCard(Card.Type.CONTRIBUTOR, pContext.getString(R.string.credits), formatContributors(pContext), "ic_face");
    }
