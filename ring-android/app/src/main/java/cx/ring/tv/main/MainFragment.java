...
public class MainFragment extends BaseBrowseFragment<MainPresenter> implements MainView {
    ...
    public static final int ID_LICENCE = 1;
    public static final int ID_CONTRIBUTORS = 2;
    ...
    private Row createAboutCardRow() {
        List<Card> cards = new ArrayList<>();
        cards.add(new AboutCard(ID_ABOUT, getString(R.string.version_section) + " " + BuildConfig.VERSION_NAME, "", "ic_ring_logo_white"));
