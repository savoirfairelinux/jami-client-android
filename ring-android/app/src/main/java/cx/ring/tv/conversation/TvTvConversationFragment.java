...
public class TvTvConversationFragment extends BaseSupportFragment<TvConversationPresenter> implements TvConversationView {
    ...
    public static TvTvConversationFragment newInstance(TVListViewModel param) {
        TvTvConversationFragment fragment = new TvTvConversationFragment();
