...
public abstract class RingGuidedStepFragment<T extends RootPresenter> extends GuidedStepFragment {
    ...
    protected static void addEditListenerTextAction(List<GuidedAction> actions, int id,
                                            String title, String desc, String editdesc) {
    ...
    protected static void addPasswordtAction(List<GuidedAction> actions, int id,
                                             String title, String desc, String editdesc) {
        actions.add(
                new GuidedAction.Builder()
                        .id(id)
