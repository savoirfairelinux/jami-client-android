...
public class TVAccountExport
    ...
    public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
        String title = getString(R.string.account_link_export_button);
        String breadcrumb = "";
        String description = getString(R.string.account_link_export_info);
        Drawable icon = getActivity().getResources().getDrawable(R.drawable.ic_add_white);
