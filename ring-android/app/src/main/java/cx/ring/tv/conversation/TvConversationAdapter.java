...
public class TvConversationAdapter extends RecyclerView.Adapter<TvConversationViewHolder> {
    ...
    private final TvTvConversationFragment mTvConversationFragment;
    ...
    public TvConversationAdapter(TvTvConversationFragment tvConversationFragment, TvConversationPresenter presenter) {
...
//            longPressView.getBackground().setTintList(null);
        ...
        longPressView.setOnLongClickListener(v -> {
            if (type == TransferMsgType.AUDIO || type == TransferMsgType.FILE) {
                ...
                longPressView.getBackground().setTint(mTvConversationFragment.getResources().getColor(R.color.grey_500));
            }
    ...
    private void configureForTextMessage(@NonNull final TvConversationViewHolder convViewHolder,
        ...
        longPressView.setOnLongClickListener((View v) -> {
            ...
            if (textMessage.isIncoming()) {
                ...
                longPressView.getBackground().setTint(mTvConversationFragment.getResources().getColor(R.color.blue_900));
            }
