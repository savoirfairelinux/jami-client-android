...
public class PluginUtils {
    ...
    public static List<PluginDetails> listAvailablePlugins(Context mContext){
        ...
        List<String> pluginsPaths = JamiService.listAvailablePlugins();
        List<String> loadedPluginsPaths = JamiService.listLoadedPlugins();
    ...
    public static void togglePlugin(String path, boolean toggle) {
        JamiService.togglePlugin(path, toggle);
    }
    ...
    public static List<String> listLoadedPlugins() {
        return JamiService.listLoadedPlugins();
    }
