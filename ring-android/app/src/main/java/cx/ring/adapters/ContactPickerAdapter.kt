...
class ContactPickerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContactPickerViewHolder {
        ...
        return if (viewType == 0) ContactPickerViewHolder(ItemSmartlistBinding.inflate(layoutInflater, parent, false), disposable)
        else ContactPickerViewHolder(ItemSmartlistHeaderBinding.inflate(layoutInflater, parent, false), disposable)
    }
