...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationViewHolder> {
     ...
     * @param mId  the message id initiating the update, 0 if full refresh
     */
    public void updateDataset(final ArrayList<Conversation.ConversationElement> list, long mId) {
        Log.d(TAG, "updateDataset, list size: " + list.size() + " - mId: " + mId);
