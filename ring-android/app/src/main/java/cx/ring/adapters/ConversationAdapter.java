...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationViewHolder> {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (interaction == null)
            return false;
        if (interaction.getType().equals(InteractionType.CONTACT))
            return false;

        switch (item.getItemId()) {
            case R.id.conv_action_download: {
              //   presenter.saveFile((DataTransfer) interaction);
                break;
            }
            case R.id.conv_action_share: {
               //   presenter.shareFile((DataTransfer) interaction);
                break;
            }
            case R.id.conv_action_open: {
              //   presenter.openFile((DataTransfer) interaction);
                break;
            }
            ...
            case R.id.conv_action_cancel_message: {
                presenter.cancelMessage((TextMessage) interaction);
                break;
            }
    ...
    private void configureForFileInfoTextMessage(@NonNull final ConversationViewHolder viewHolder,
                                                 @NonNull final Interaction conversationElement, int position) {
        DataTransfer file = new DataTransfer(conversationElement);
    ...
    private void configureForTextMessage(@NonNull final ConversationViewHolder convViewHolder,
        ...
        longPressView.setOnCreateContextMenuListener((menu, v, menuInfo) -> {
            ...
            if ((interaction).getStatus().equals(InteractionStatus.SENDING)) {
    ...
    private boolean isMessageConfigSameAsPrevious(final Interaction textMessage,
        ...
        if (previousMessage != null &&
                textMessage.getType().equals(previousMessage.getType()) &&
