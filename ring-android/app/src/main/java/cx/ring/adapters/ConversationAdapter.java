...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationViewHolder> {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.conv_action_delete_file: {
                presenter.deleteConversationItem((DataTransfer) conversationElement);
                break;
            }
            case R.id.conv_action_delete_message: {
                presenter.deleteConversationItem((TextMessage) conversationElement);
                break;
            }
            case R.id.conv_action_delete_call_history: {
                presenter.deleteConversationItem((HistoryCall) conversationElement);
                break;
            }
