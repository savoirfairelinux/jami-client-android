...
class ConversationAdapter(
    ...
    private val uiScheduler: Scheduler = Schedulers.from {
    ...
    private val timestampUpdateTimer: Observable<Long> = Observable.interval(10, TimeUnit.SECONDS, uiScheduler)
        .startWithItem(0L)
        ...
        try {
            ...
            if (player != null) {
                ...
                viewHolder.compositeDisposable.add(
                    Observable.interval(1L, TimeUnit.SECONDS, uiScheduler)
                        .startWithItem(0L)
                        .subscribe {
