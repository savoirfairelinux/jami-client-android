...
public class RingApplication extends Application {
    ...
    public void videoSurfaceAdded(String id) {
        android.util.Log.d(TAG, "DRingService.videoSurfaceAdded() " + id);
    ...
    public void videoSurfaceRemoved(String id) {
        android.util.Log.d(TAG, "DRingService.videoSurfaceRemoved() " + id);
        Shm shm = videoInputs.get(id);
        if (shm != null) {
            stopVideo(shm);
        }
    ...
    public void videoPreviewSurfaceAdded() {
        android.util.Log.i(TAG, "DRingService.videoPreviewSurfaceChanged()");
