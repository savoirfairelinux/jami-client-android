    ...
    private void updateDatabaseFrom8(SQLiteDatabase db) throws SQLiteException {
        if (db != null && db.isOpen()) {
            try {
                ...
                Log.e(TAG, "Migration from database version 8 to next, failed.", exception);
            }
                ...
                if (callTable.moveToFirst()) {
                    ...
                    while (!callTable.isAfterLast()) {
                        ...
                        if (accountId != null && contactId != null) {
                            ...
                            if (!contactId.contains(CallContact.PREFIX_RING)) {
                                contactId = CallContact.PREFIX_RING + contactId;
                            }
