...
//        binding.btnEndExport.setOnClickListener(v -> hidePopWizard());
        ...
        binding.username.setLeftDrawableOnClickListener(v -> profileContainerClicked());
...
//        binding.groupRegisteredName.setVisibility(hasRegisteredName ? View.VISIBLE : View.GONE);
        binding.registeredName.setRightDrawable(hasRegisteredName? R.drawable.baseline_content_copy_twoton_24dp : R.drawable.baseline_edit_twoton_24dp);
        binding.registeredName.setText(hasRegisteredName? username : getResources().getString(R.string.no_registered_name));
        binding.username.setRightDrawableOnClickListener(v -> QRCodeFragment.newInstance(QRCodeFragment.INDEX_CODE).show(getParentFragmentManager(), QRCodeFragment.TAG));
