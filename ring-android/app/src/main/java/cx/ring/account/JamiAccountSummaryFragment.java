...
public class JamiAccountSummaryFragment extends BaseSupportFragment<JamiAccountSummaryPresenter> implements
    ...
    public void accountChanged(@NonNull final Account account) {
        ...
        mBinding.registeredName.setText(hasRegisteredName? username : getResources().getString(R.string.no_registered_name));
        ...
        mBinding.username.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                if (!TextUtils.isEmpty(s)) {
                    presenter.saveVCardFormattedName(s.toString().trim());
                }
            }
        });
