...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            thumbColor = ta.getColor(R.styleable.SwitchButton_thumbColor, Color.WHITE);
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            moveRange = ceil(mThumbWidth * mThumbRangeRatio);
            textExtraSpace = ceil(textWidth + mTextExtra - (moveRange - mThumbWidth + Math.max(mThumbMargin.left, mThumbMargin.right)));
    ...
    private void setup() {
        ...
        if (mOnLayout != null) {
            float onLeft = mBackRectF.left + (mBackRectF.width() - mThumbWidth - mThumbMargin.right - mOnLayout.getWidth()) / 2f - mTextAdjust;
        ...
        if (mOffLayout != null) {
            float offLeft = mBackRectF.right - (mBackRectF.width() - mThumbWidth - mThumbMargin.left - mOffLayout.getWidth()) / 2f - mOffLayout.getWidth() + mTextAdjust;
    ...
    protected void drawableStateChanged() {
        ...
        mOnTextColor = R.color.white;
        mOffTextColor = R.color.white;
    }
