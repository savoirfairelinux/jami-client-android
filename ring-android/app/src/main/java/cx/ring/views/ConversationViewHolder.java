...
public class ConversationViewHolder extends RecyclerView.ViewHolder {
    ...
    public ConversationViewHolder(ViewGroup v, int type) {
        super(v);
        if (type == ConversationActivity.ConversationMessageType.CALL_INFORMATION_TEXT_MESSAGE.getType()) {
            ...
            if (type == ConversationActivity.ConversationMessageType.INCOMING_TEXT_MESSAGE.getType())
