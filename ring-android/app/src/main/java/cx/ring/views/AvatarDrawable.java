...
public class AvatarDrawable extends Drawable {
    ...
    public static Single<AvatarDrawable> loadFromProfile(Context context, Account account, boolean crop) {
    ...
    public static Single<AvatarDrawable> loadFromProfile(Context context, Account account) {
        return loadFromProfile(context, account, true);
    }
