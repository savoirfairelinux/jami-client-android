...
class ParticipantsContainerView @JvmOverloads constructor(
    ...
    fun init() {
        ...
        val inactiveWidth = if (grid || mainWidth < mainHeight) 1f/inactiveMaxCols else activeSeparation
        val gridRows = if (grid) inactiveParticipants / inactiveMaxCols else 0
        val inactiveHeight = if (grid) (1f / gridRows) else if (mainWidth < mainHeight) activeSeparation else 1f/inactiveMaxRows
