...
class ParticipantsContainerView// adding name, mic etc..
    ...
    fun initialize() {
        ...
        for (i in participants) {
            ...
            val layoutParams = LayoutParams(if (portrait) LayoutParams.MATCH_PARENT else ViewGroup.LayoutParams.WRAP_CONTENT,
                if (portrait) ViewGroup.LayoutParams.WRAP_CONTENT else LayoutParams.MATCH_PARENT)
