...
public class ConversationFacade {
    ...
    private Observable<SmartListViewModel> observeConversation(Account account, Conversation conversation) {
        return account.getConversationSubject()
                ...
                .switchMap(c -> mContactService
                        .observeContact(c.getAccountId(), c.getContact())
                        .map(contact -> new SmartListViewModel(c.getAccountId(), c.getUri(), contact, c.getLastEvent())));
    }
    ...
    public Observable<List<Observable<SmartListViewModel>>> getSmartList() {
        return getSmartList(mAccountService.getCurrentAccountSubject());
    }
