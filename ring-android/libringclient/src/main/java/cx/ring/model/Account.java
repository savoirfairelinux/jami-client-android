...
public class Account {
    ...
    /**
     * Updates a cached conversation with the conversation id
     *
     * @param history a conversation history object which has a valid id
     */
    ...
    public Conversation getConversationFromHistory(ConversationHistory history) {
        String key = history.getParticipant();
        Conversation conversation = getByUri(key);
