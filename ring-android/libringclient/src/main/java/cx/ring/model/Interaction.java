...
public class Interaction {
    ...
    public Interaction(String author, ConversationHistory conversation, String body, String type, String status, String daemonId) {
        mAuthor = author;
    ...
    public enum InteractionStatus {
        ...
        InteractionStatus(boolean isError) {
