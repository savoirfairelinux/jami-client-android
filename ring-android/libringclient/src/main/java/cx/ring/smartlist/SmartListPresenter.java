...
public class SmartListPresenter extends RootPresenter<SmartListView> implements Observer<ServiceEvent> {
    ...
    public SmartListPresenter(AccountService accountService, ContactService contactService,
        ...
        this.mSettingsService = sharedPreferencesService;
    ...
    private void refreshConnectivity() {
        boolean isConnected = mSettingsService.isConnectedWifi()
                || (mSettingsService.isConnectedMobile() && mSettingsService.getUserSettings().isAllowMobileData());

        boolean isMobileAndNotAllowed = mSettingsService.isConnectedMobile()
