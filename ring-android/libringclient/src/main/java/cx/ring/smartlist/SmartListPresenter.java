...
public class SmartListPresenter extends RootPresenter<SmartListView> implements Observer<ServiceEvent> {
    ...
    private SmartListViewModel createViewModelFromContact(@NonNull CallContact callContact) {
        ...
        smartListViewModel.setHasOngoingCall(mCallService.getCurrentCallForContactId(callContact.getIds().get(0)) != null);
    ...
    public void removeContact(SmartListViewModel smartListViewModel) {
        ...
        mContactService.removeContact(mCurrentAccount.getAccountID(), contactId, true);
