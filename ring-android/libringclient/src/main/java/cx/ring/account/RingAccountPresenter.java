...
public class RingAccountPresenter extends RootPresenter<RingAccountView> implements Observer<ServiceEvent> {

    private static final String TAG = RingAccountPresenter.class.getSimpleName();
    ...
    @Override
    public void bindView(RingAccountView view) {
