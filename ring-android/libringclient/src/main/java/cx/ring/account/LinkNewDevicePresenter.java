...
public class LinkNewDevicePresenter extends RootPresenter<LinkNewDeviceView> {

    private static final String TAG = LinkNewDevicePresenter.class.getSimpleName();
    ...
    @Inject
    public LinkNewDevicePresenter(AccountService accountService) {
    ...
    public void setAccountId(String accountID) {
        ...
        mCompositeDisposable.add(mAccountService.getObservableAccountUpdates(mAccountID)
                .observeOn(mUiScheduler)
                .subscribe(a -> {
                    LinkNewDeviceView view = getView();
                    if (view != null)
