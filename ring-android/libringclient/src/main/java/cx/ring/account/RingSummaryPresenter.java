...
public class RingSummaryPresenter extends RootPresenter<RingSummaryView> implements Observer<ServiceEvent> {

    private static final String TAG = RingSummaryPresenter.class.getSimpleName();
    ...
    @Override
    public void bindView(RingSummaryView view) {
