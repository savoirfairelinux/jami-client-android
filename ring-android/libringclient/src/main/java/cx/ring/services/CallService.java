...
public class CallService extends Observable {
    ...
    private CallCallbackHandler mCallbackHandler;

    public CallService(DaemonService daemonService) {
        mCallbackHandler = new CallCallbackHandler();
    }

    public CallCallbackHandler getCallbackHandler() {
    ...
    public class CallCallbackHandler {
