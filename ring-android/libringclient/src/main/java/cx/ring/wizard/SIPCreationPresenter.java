...
public class SIPCreationPresenter extends RootPresenter<SIPCreationView> implements Observer<DaemonEvent> {
    ...
    public void update(Observable observable, DaemonEvent event) {
        ...
        switch (event.getEventType()) {
            case REGISTRATION_STATE_CHANGED:
                ...
                handleNewAccountState(event.getEventInput(DaemonEvent.EventInput.STATE, String.class));
     ...
     * @param hasVideoPermission account should enable video
     * @param bypassWarning      Report eventual warning to the user
     */
    public void startCreation(String alias, String hostname, String username, String password, boolean hasVideoPermission, boolean bypassWarning) {
        ...
        if (warningIPAccount && !bypassWarning) {
            ...
            HashMap<String, String> accountDetails = initAccountDetails(hasVideoPermission);
    ...
    private HashMap<String, String> initAccountDetails(boolean hasVideoPermission) {
        ...
        try {
            ...
            accountDetails.put(ConfigKey.VIDEO_ENABLED.key(), Boolean.toString(hasVideoPermission));
