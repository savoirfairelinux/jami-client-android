...
public final class VCardUtils {
    ...
    /**
     * Copies a vcard to a new destination.
     * @param source the files directory
     * @param destination the file to copy to
     * @param filename the name of the required vcard
     */
    private static void migrateProfile(File source, File destination, String filename) {
        File legacyProfileFolder = new File(source, "peer_profiles");
        if(legacyProfileFolder.exists()) {
            ...
            for(File profile : profiles) {
                if(profile.getName().equals(filename)) {
    ...
    public static VCard loadPeerProfileFromDisk(File filesDir, String filename, String accountId) {
        ...
        migrateProfile(filesDir, profilePath, filename);
