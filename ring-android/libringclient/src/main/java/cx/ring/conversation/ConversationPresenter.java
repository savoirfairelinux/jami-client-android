...
public class ConversationPresenter extends RootPresenter<ConversationView> {
    ...
    public void deleteConversationItem(ConversationElement element) {
        switch (element.getType()) {
            case TEXT:
                mConversationFacade.deleteConversationItem((TextMessage) element);
                break;
            case FILE:
                mConversationFacade.deleteConversationItem((DataTransfer) element);
                break;
            case CALL:
                mConversationFacade.deleteConversationItem((HistoryCall) element);
                break;
        }
    }
