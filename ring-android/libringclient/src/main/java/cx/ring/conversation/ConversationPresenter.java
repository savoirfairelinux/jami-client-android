...
public class ConversationPresenter extends RootPresenter<ConversationView> implements Observer<ServiceEvent> {
    ...
    public void blockContact() {
        mAccountService.removeContact(mAccountId, mContactRingId, true);
        getView().goToHome();
    }
    ...
    private void loadHistory() {
        ...
        mHistoryService.getAllTextMessagesForAccountAndContactRingId(mAccountId, mContactRingId)
    ...
    private void checkContact() {
        ...
        getView().displaySendTrustRequest(mAccountId, mContactRingId);
    }
