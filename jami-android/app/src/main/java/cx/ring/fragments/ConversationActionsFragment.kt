...
class ConversationActionsFragment : Fragment(), Colorable {
    ...
    private fun setConversationPreferences(
        ...
        mConversationFacade.setConversationPreferences(accountId, conversationUri, mapOf(
            Conversation.KEY_PREFERENCE_CONVERSATION_SYMBOL to emoji,
            Conversation.KEY_PREFERENCE_CONVERSATION_COLOR to if (color != null) String.format("#%06X", 0xFFFFFF and color) else ""
        ))
    }
