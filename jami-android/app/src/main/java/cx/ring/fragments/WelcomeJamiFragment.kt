...
import cx.ring.utils.ImageViewUtils
                    ...
                    uiState.uiCustomization?.apply {
                        ...
                        when (backgroundType) {
                            ...
                            BackgroundType.IMAGE -> {
                                backgroundUrl?.let {
                                    ImageViewUtils.setImage(binding?.welcomeJamiBackground!!, it)
                                }
                        ...
                        logoUrl?.let { ImageViewUtils.setImage(binding?.welcomeJamiLogo!!, it) }
                        logoSize?.let { size ->
                            ...
                            val newSize = size * (defaultSize ?: 0) / 100
