    ...
    private fun startAudioRecording() {
        ...
        val started = try {
            recorder.apply {
                ...
                setMaxFileSize(MAX_AUDIO_FILE_SIZE)
        ...
        if (!presenter.deviceRuntimeService.hasVideoPermission()) {
            ...
            try {
                ...
                val intent = Intent(MediaStore.ACTION_VIDEO_CAPTURE).apply {
                    ...
                    putExtra(MediaStore.EXTRA_SIZE_LIMIT, MAX_VIDEO_FILE_SIZE)
                }
...
//    }
    ...
    companion object {
        ...
        private const val MAX_AUDIO_FILE_SIZE = 10_000_000L // 10 MB
        private const val MAX_VIDEO_FILE_SIZE = 100_000_000L // 100 MB
