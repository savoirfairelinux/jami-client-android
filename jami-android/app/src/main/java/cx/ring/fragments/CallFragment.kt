...
class CallFragment : BaseSupportFragment<CallPresenter, CallView>(), CallView,
    ...
    private fun setBottomSheet(newInset: WindowInsetsCompat? = null) {
        ...
        val screenHeight = binding.callCoordinatorOptionContainer.height.takeIf { it > 0 } ?: return
        // Calculate the height of the grid view (content only, no padding).
        ...
        val bottomSheetHeight =
            binding.constraintBsContainer.height - binding.constraintBsContainer.paddingBottom
        ...
        val offset = screenHeight - bottomSheetHeight - bottomInset
