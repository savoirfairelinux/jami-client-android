...
class CallFragment : BaseSupportFragment<CallPresenter, CallView>(), CallView,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.let { binding ->
            ...
            binding.fullscreenCameraPreview.surfaceTextureListener = object : TextureView.SurfaceTextureListener {
                override fun onSurfaceTextureAvailable(surface: SurfaceTexture, width: Int, height: Int) {
                    Log.d("TransformDebug", "onSurfaceTextureAvailable fullscreenPreview: width: $width, height: $height")
                ...
                override fun onSurfaceTextureSizeChanged(surface: SurfaceTexture, width: Int, height: Int) {
                    Log.d("TransformDebug", "onSurfaceTextureSizeChanged fullscreenPreview: width: $width, height: $height")
                    configureTransform(binding.fullscreenCameraPreview, width, height)
                }
            ...
            binding.previewSurface.addOnLayoutChangeListener { _, _, _, _, _, _, _, _, _ ->
                Log.d("TransformDebug", "onLayoutChange previewSurface: width: ${binding.previewSurface.width}, height: ${binding.previewSurface.height}")
