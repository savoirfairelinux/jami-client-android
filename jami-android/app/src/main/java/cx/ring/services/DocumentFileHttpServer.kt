...
class DocumentFileHttpServer private constructor(
    ...
    private fun serveFile(file: DocumentFile): Response {
        ...
        val mime = MIME_DB[ext] ?: (file.type ?: "application/octet-stream")
        return try {
