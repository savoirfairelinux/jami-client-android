...
class HardwareServiceImpl(
    ...
    override fun startCapture(camId: String?) {
        ...
        Log.d("pavan", "startCapture: opening camera preview for $cam preview cam id: $mPreviewCamId, videoParams.isCapturing: ${videoParams.isCapturing}, useHardwareCodec: $useHardwareCodec")
        if (cam != mPreviewCamId || !videoParams.isCapturing) {
            ...
            Log.w("pavan", "startCapture: already capturing on $cam")
