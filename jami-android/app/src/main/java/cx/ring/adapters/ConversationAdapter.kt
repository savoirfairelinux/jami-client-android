...
class ConversationAdapter(
    ...
    private fun configureDisplayIndicator(
        ...
        Log.w("devdebug", "configureDisplayIndicator ${interaction.type}")
        ...
        Log.w("devdebug", "configureDisplayIndicator $isDisplayed $isReceived $contacts $currentIdx lastDisplayedMessages=${lastDisplayedIdx}")
