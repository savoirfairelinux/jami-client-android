...
class ConfParticipantAdapter(
    ...
    /**
     * The displayed list concatenates conference participants with the calls
     * still being placed, so a participant is only identified by the fields
     * that tell those two sources apart.
     */
