...
Log.d("ASDF", "setFitToContent:${i.active && !pipMode}")
            participantInfoOverlay.sink.setFitToContent(i.active && !pipMode) // todo make this update right away? just use layoutparams?
    ...
    fun getPipFocusParticipant() = participants.firstOrNull { it.getTag() != "host_video_0" } // todo any host_video?
