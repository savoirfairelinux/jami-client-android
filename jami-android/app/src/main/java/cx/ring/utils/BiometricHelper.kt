...
object BiometricHelper {
    ...
    private fun startBiometricLogin(fragment: Fragment, accountId: String, callback: (ByteArray?) -> Unit) {
        ...
        val biometricPrompt = BiometricPrompt(fragment, ContextCompat.getMainExecutor(context),
            object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationFailed() {
                    Toast.makeText(context.applicationContext, context.getString(R.string.account_auth_failed), Toast.LENGTH_SHORT).show()
                    callback(null)
                }
            })
    ...
    class BiometricEnroll(
        ...
        private val biometricPromptCallback = object : BiometricPrompt.AuthenticationCallback() {
            ...
            override fun onAuthenticationFailed() {
                Toast.makeText(applicationContext, applicationContext.getText(R.string.account_auth_failed), Toast.LENGTH_SHORT).show()
                callback(null)
            }
        }
        ...
        private val promptInfo = BiometricPrompt.PromptInfo.Builder()
            ...
            .setDescription(applicationContext.getText(R.string.account_biometry_enroll_auth_message))
            //.setNegativeButtonText("Use account password")
