...
class EditTextPinInputFragment : Fragment() {
    ...
    private fun showErrorPanel() {
        binding.enterPin.error = getString(R.string.ringtone_error_format_not_supported)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        enterPinEditText.doOnTextChanged { pin, _, _, _ ->
            viewModel.checkPin(pin.toString()).let {
                // if the pin is not valid and it is at length 17 (format of the pin) there is an error
