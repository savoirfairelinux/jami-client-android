...
class HomeAccountCreationFragment :
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View =
        FragAccHomeCreateBinding.inflate(inflater, container, false).apply {
            importBackupLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
    ...
    private fun performFileSearch() {
        try {
            ...
            importBackupLauncher.launch(Intent(Intent.ACTION_OPEN_DOCUMENT)
