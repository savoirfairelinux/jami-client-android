...
//    var viewModel = ViewModelProvider(this)[QrToPinViewModel::class.java]
//    var binding = FragQrToPinBinding.inflate(layoutInflater)
    ...
    override fun onCreateView(inflater: LayoutInflater,
      ...
      override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        super.onViewCreated(view, savedInstanceState)
          ...
          checkPermission()
          viewModel.event.observe(viewLifecycleOwner, Observer { state:State ->
              when (state) {
                  State.INIT -> showInit()
                  State.VALID -> showValid()
