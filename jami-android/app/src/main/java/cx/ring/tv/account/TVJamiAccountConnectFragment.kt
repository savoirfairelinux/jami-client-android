...
@AndroidEntryPoint
class TVJamiAccountConnectFragment : JamiGuidedStepFragment<JamiAccountConnectPresenter, JamiConnectAccountView>(),
    ...
    override fun onCreateGuidance(savedInstanceState: Bundle?): Guidance {
        ...
        val description = """
            ...
            ${getString(R.string.help_connect_password_enter)}
            """.trimIndent()
    ...
    override fun onGuidedActionEditedAndProceed(action: GuidedAction): Long {
        when (action.id) {
            ...
            PASSWORD -> {
                action.description = if (action.editDescription.toString().isNotEmpty()) toPassword(action.editDescription.toString()) else getString(R.string.account_enter_password)
