...
abstract class JamiApplication : Application() {
    ...
    private val IDLE_SHUTDOWN_DELAY_MS = 90_000L
    ...
    fun scheduleIdleShutdown() {
        ...
        idleHandler.postDelayed(idleShutdownRunnable, IDLE_SHUTDOWN_DELAY_MS)
    }
     ...
     * Starts the idle shutdown timer and signals PushForegroundService to stop early.
     */
    fun onPushProcessed() {
        if (!isInForeground) {
