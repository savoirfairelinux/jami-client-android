    ...
    fun bootstrapDaemon() {
        ...
        mExecutor.execute {
            ...
            try {
                ...
                // Executor threads are reused; clearing the flag here ensures
                // that a later unrelated task running on the same thread is
                // not mistaken for a bootstrap task by ensureDaemonStarted().
                onDaemonExecutor.set(false)
            }
        }
    }
