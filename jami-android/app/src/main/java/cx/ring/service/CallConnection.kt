...
class CallConnection(
    ...
    override fun onAnswer(videoState: Int) {
        Log.w(TAG, "onAnswer")
        service.callService.accept(call!!.account!!, call!!.daemonIdString!!, videoState == VideoProfile.STATE_BIDIRECTIONAL)
    }

    override fun onReject() {
        Log.w(TAG, "onReject")
        service.callService.refuse(call!!.account!!, call!!.daemonIdString!!)
    }
