...
class JamiFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        serviceScope.launch {
            try {
                if (app != null) {
                    // Ensure daemon is fully started before acquiring the push hold and
                    // dispatching: onPushReceived() reactivates accounts synchronously,
                    // which requires the daemon to already be running.
