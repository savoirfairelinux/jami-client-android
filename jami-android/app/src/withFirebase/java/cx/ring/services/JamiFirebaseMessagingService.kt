...
class JamiFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        val isCallNotification = isCallWakeup && remoteMessage.originalPriority == RemoteMessage.PRIORITY_HIGH
        val needsFgs = (isCallNotification || isMessageWakeup) && !appInForeground
        if (needsFgs) {
            try {
