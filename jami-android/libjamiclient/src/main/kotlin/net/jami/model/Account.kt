...
class Account(
    ...
    private val conversationsWithLastEventSubject: Observable<Array<Any>> = getLatest(conversationMapSubject).share()
    private val conversationsSubject: Observable<List<Conversation>> = conversationsWithLastEventSubject.map(::getSorted)
    ...
    companion object {
        ...
        fun getLatest(conversation: Subject<Map<String, Conversation>>) = conversation.switchMap { conversations ->
        ...
        fun getSorted(conversations: Array<Any>): List<Conversation> {
