...
class Conversation : ConversationHistory {
    ...
    private val notification: Subject<Boolean> = BehaviorSubject.createDefault(true)
     ...
     */
    fun getNotification(): Observable<Boolean> = notification
    ...
    fun updatePreferences(preferences: Map<String, String>) {
        ...
        preferences[KEY_PREFERENCE_CONVERSATION_NOTIFICATION]?.let {
            notification.onNext(it.toBoolean())
