...
class Conversation : ConversationHistory {
    ...
    // Notification preference. Return true if the notification is enabled, false otherwise.
    ...
    val isNotificationEnabled: Boolean = isNotificationEnabledSubject.blockingFirst()
