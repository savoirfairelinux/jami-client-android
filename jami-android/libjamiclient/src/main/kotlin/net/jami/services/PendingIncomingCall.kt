...
class PendingIncomingCall(
    ...
    val result: Single<CallService.SystemCall> = subject.doFinally {
        // Repeated ringing updates may share this wait. Only the last waiter can abandon it.
        if (!subject.hasObservers()) cancel()
    }
