...
class AccountService(
     ...
     * @param flag TODO Explain what flag is
     */
    ...
    private fun addMessage(
        ...
        // TODO confirm I can delete these commented lines
        return interaction
    }
        ...
        getAccount(accountId)?.let { account ->
            account.getSwarm(conversationId)?.let { conversation ->
                synchronized(conversation) {
                    ...
                    // Manage notification TODO Please confirm at review
                    val isIncoming = !interaction.contact!!.isUser
                    if (isIncoming)
                        incomingSwarmMessageSubject.onNext(interaction)
                    // Manage data if data transfer interaction. TODO Please confirm at review
