...
class AccountService(
    ...
    fun loadMore(conversation: Conversation, n: Int = 32): Single<Conversation> {
        synchronized(conversation) {
            ...
            // load the next n messages before the oldest one in the history
    ...
    private fun getInteraction(
        ...
        if (replyTo != null) {
            // todo prevent in search / populate replyTo from elsewhere as it's guarenteed to be laoded by the daemon
