...
class HomeNavigationPresenter @Inject constructor(
    ...
    fun updateProfile(displayName: String?, avatar: String?, fileType: String?,
        flag: Int) {
        val account = mAccountService.currentAccount!!
        val mAccountId = account.accountId
        mAccountService.updateProfile(mAccountId, displayName, avatar, fileType, flag)
    }
